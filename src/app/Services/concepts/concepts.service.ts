...
export class ConceptsService {
  ...
  private urlget : string = "https://hidden-shore-15479.herokuapp.com/api/v1/concepts.json";
  private urlpost : string = "https://hidden-shore-15479.herokuapp.com/api/v1/concepts"
